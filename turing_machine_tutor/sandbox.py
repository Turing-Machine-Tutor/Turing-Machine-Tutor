...
controller.add_challenge("mydick","turing machine that accepts 0n1n",is_0n1n,{"0011","01"});
controller.add_challenge("penis","turing machine that accepts 0n1n",is_0n1n,{"0011","01"});
...
controller.add_challenge("combined_shit","turing machine that accepts 0n1n",is_0n1n,{"0011","01"});
controller.validate_combined_turing_machine_with_while_condition('combined_shit',step6)
...
controller.validate_turing_machine('combined_shit')
