...
transition_function = {
    ...
    ('q0', '0', 'B'): multi_next('q1', '0', '0', 'R', 'R'),
    ('q0', '1', 'B'): multi_next('q1', '1', '1', 'R', 'R'),
    ('q0', 'B', 'B'): multi_next('qa', 'B', 'B', 'S', 'S'),

    ('q1', '0', 'B'): multi_next('q1', '0', '0', 'R', 'R'),
    ('q1', '1', 'B'): multi_next('q1', '1', '1', 'R', 'R'),
    ('q1', 'B', 'B'): multi_next('qa', 'B', 'B', 'S', 'S'),
}
start_state = 'q0'
accept_state = 'qa'
reject_state = 'qr'
